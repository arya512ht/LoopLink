...
export const messengerReducer = (state=messengerState,action) => {
     ...
     if(type === UPDATE_FRIEND_MESSAGE){
          const index = state.friends.findIndex(f=>f.fndInfo.id === payload.msgInfo.reseverId || f.fndInfo.id === payload.msgInfo.senderId);
     ...
     if(type === UPDATE){
          const index = state.friends.findIndex(f=>f.fndInfo.id === payload.id);
     ...
     if(type === 'SEEN_ALL'){
          const index = state.friends.findIndex(f=>f.fndInfo.id === payload.reseverId);
          state.friends[index].msgInfo.status = 'seen';
          return {
               ...state
          }
