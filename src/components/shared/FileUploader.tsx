...
const FileUploader = ({ fieldChange, mediaUrl }: FileUploaderProps) => {
  ...
  return (
    <div className="flex flex-center flex-col bg-dark-3 rounded-xl cursor-pointer border border-gray-400" {...getRootProps()}>
      <input {...getInputProps()} className="cursor-pointer" />

      {fileUrl ? (
        <>
          <div className="flex flex-1 justify-center w-full p-5 lg:p-10 border-b border-gray-400">
